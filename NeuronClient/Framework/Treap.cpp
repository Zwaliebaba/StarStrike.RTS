...
{
	SDWORD result;
	char *pStr1 = (char *)key1;
	char *pStr2 = (char *)key2;
							   ...
							   TREAP_CMP cmp)
{
	...
	case 0:
		...
		break;
	default:
		ASSERT_TEXT(FALSE, "treapDelRec: invalid return from comparison");
		break;
	}
}
...
void *treapFindRec(TREAP_NODE *psRoot, UDWORD key, TREAP_CMP cmp)
{
	...
	case 1:
		...
		break;
	default:
		ASSERT_TEXT(FALSE, "treapFindRec: invalid return from comparison");
		break;
	}
}
