...
uint8 pal_GetNearestColour(uint8 r, uint8 g, uint8 b)
{
	...
	ASSERT_TEXT(bPaletteInitialised,"pal_GetNearestColour, palette !initialised.");
...
int		numShades;
	...
	ASSERT_TEXT(bPaletteInitialised,"pal_BuildAdjustedShadeTable, palette !initialised.");
...
{
	ASSERT_TEXT(bPaletteInitialised,"pie_GetGamePal, palette !initialised");
	return 	psGamePal;
}
