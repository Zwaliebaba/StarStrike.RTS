...
static int min_dist[NO_OF_SHIPS + 1] = {0, 200, 800, 200, 200, 200, 300, 384, 200, 200, 200, 420, 900, 500, 800, 384, 384, 384, 384, 384, 200, 384, 384, 384, 0, 384, 0, 384, 384, 700, 384, 0, 0, 900};
...
void update_intro1(void)
{
  ...
  if (universe[0].location.z < 384) universe[0].location.z = 384;
...
void update_intro2(void)
{
  ...
  if ((show_time >= 140) && (direction < 0)) direction = -direction;
