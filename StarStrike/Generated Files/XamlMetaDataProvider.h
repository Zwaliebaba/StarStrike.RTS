...
namespace winrt::StarStrike::implementation
{
    using IXamlMember = ::winrt::Microsoft::UI::Xaml::Markup::IXamlMember;
    using IXamlType = ::winrt::Microsoft::UI::Xaml::Markup::IXamlType;

    struct XamlMetaDataProvider : public ::winrt::StarStrike::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
...
namespace winrt::StarStrike::factory_implementation
{
