...
/*	{ "addTutorialMessage",		scrAddTutorialMessage,	VAL_VOID,
	...
	{ "pickStructLocation",		scrPickStructLocation,	VAL_BOOL,
		4, {(INTERP_TYPE)ST_STRUCTURESTAT, (INTERP_TYPE)(VAL_REF|VAL_INT), (INTERP_TYPE)(VAL_REF|VAL_INT), VAL_INT } },
	...
	{ "getNearestGateway",		scrGetNearestGateway,	VAL_BOOL,	
		4, { VAL_INT, VAL_INT, (INTERP_TYPE)(VAL_REF|VAL_INT), (INTERP_TYPE)(VAL_REF|VAL_INT) } },
...
//ajl skirmish funcs
	...
	6, {(INTERP_TYPE)(VAL_REF|VAL_INT), (INTERP_TYPE)(VAL_REF|VAL_INT), (INTERP_TYPE)ST_STRUCTURESTAT, (INTERP_TYPE)ST_STRUCTURESTAT, (INTERP_TYPE)ST_DROID,VAL_INT } },
 ...
 *
 *   "variable_identifier", <variable type>, ST_EXTERN,(INTERP_TYPE)0, <index>,
...
{
	{ "isPSX",			VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_ISPSX,
		scrGenExternGet,		NULL },

	{ "trackTransporter",VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_TRACKTRANSPORTER,
		scrGenExternGet,		NULL },

	{ "mapWidth",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_MAPWIDTH,
		scrGenExternGet,		NULL },
	{ "mapHeight",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_MAPHEIGHT,
		scrGenExternGet,		NULL },

	{ "gameInitialised",VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_GAMEINIT,
		scrGenExternGet,		NULL },

	{ "selectedPlayer",	VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_SELECTEDPLAYER,
		scrGenExternGet,		NULL },
	{ "gameTime",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_GAMETIME,
		scrGenExternGet,		NULL },

	{ "gameLevel",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_GAMELEVEL,
		scrGenExternGet,		scrGenExternSet },
	{ "inTutorial",		VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_TUTORIAL,
		scrGenExternGet,		scrGenExternSet },
	{ "cursorType",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_CURSOR,
		scrGenExternGet, NULL },


	{ "intMode",		VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_INTMODE,
		scrGenExternGet, NULL },

	{ "targetedObjectType",	VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_TARGETTYPE,
		scrGenExternGet, NULL },
	{ "extraVictoryFlag",VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_EXTRAVICTORYFLAG,
		scrGenExternGet,		scrGenExternSet },
	{ "extraFailFlag",	VAL_BOOL,	ST_EXTERN,(INTERP_TYPE)0,		EXTID_EXTRAFAILFLAG,
		scrGenExternGet,		scrGenExternSet },



	{ "multiPlayerGameType",VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,	EXTID_MULTIGAMETYPE,
		scrGenExternGet,			NULL },

	{ "multiPlayerMaxPlayers",VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,EXTID_MULTIGAMEHUMANMAX,
		scrGenExternGet,			NULL },

	{ "multiPlayerBaseType",VAL_INT,	ST_EXTERN,(INTERP_TYPE)0,EXTID_MULTIGAMEBASETYPE,
		scrGenExternGet,			NULL },

		

	/* This entry marks the end of the variable list */
	{ NULL, VAL_VOID, ST_EXTERN,(INTERP_TYPE)0, 0, NULL, NULL }
};
...
VAR_SYMBOL asObjTable[] =
{
	...
	{ "x",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_POSX,
		scrBaseObjGet,			NULL },
	{ "y",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_POSY,
		scrBaseObjGet,			NULL },
	{ "z",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_POSZ,
		scrBaseObjGet,			NULL },
	{ "id",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_ID,
		scrBaseObjGet,			NULL },
	{ "player",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_PLAYER,
		scrBaseObjGet,			NULL },
	{ "type",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_TYPE,
		scrBaseObjGet,			NULL },
	{ "clusterID",		VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_CLUSTERID,
		scrBaseObjGet,			NULL },
	{ "health",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_BASEOBJECT,	OBJID_HEALTH,
		scrBaseObjGet,			NULL },

	// droid variables
	{ "order",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_ORDER,
		scrBaseObjGet,			NULL },
	{ "droidType",		VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_DROIDTYPE,
		scrBaseObjGet,			NULL },
	{ "body",			(INTERP_TYPE)ST_BODY,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_BODY,
		scrBaseObjGet,			NULL },
	{ "propulsion",		(INTERP_TYPE)ST_PROPULSION,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_PROPULSION,
		scrBaseObjGet,			NULL },
	{ "weapon",			(INTERP_TYPE)ST_WEAPON,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_WEAPON,
		scrBaseObjGet,			NULL },
	{ "orderx",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_ORDERX,
		scrBaseObjGet,			NULL },
	{ "ordery",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_DROID,		OBJID_ORDERY,
		scrBaseObjGet,			NULL },
	...
	// group variables
	{ "x",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_GROUP,		GROUPID_POSX,
		scrGroupObjGet,			NULL },
	{ "y",				VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_GROUP,		GROUPID_POSY,
		scrGroupObjGet,			NULL },
	{ "members",		VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_GROUP,		GROUPID_MEMBERS,
		scrGroupObjGet,			NULL },
	{ "health",			VAL_INT,	ST_OBJECT,	(INTERP_TYPE)ST_GROUP,		GROUPID_HEALTH,
		scrGroupObjGet,			NULL },
...
/*	{ "TEST_BOOL_CONST",	VAL_BOOL, TRUE,		0,		0 },
	...
	{ "(INTERP_TYPE)ST_RESEARCH",			VAL_INT,	0,	SCR_ST_RESEARCH,			0 },
	...
	{ "(INTERP_TYPE)ST_SENSOR",				VAL_INT,	0,	SCR_ST_SENSOR,				0 },
...
CALLBACK_SYMBOL asCallbackTable[] =
{
	...
	{ "CALL_DROID_SELECTED",		(TRIGGER_TYPE)CALL_DROID_SELECTED,		scrCBDroidSelected,
		1,	{ (INTERP_TYPE)(VAL_REF|ST_DROID) } },
	...
	{ "CALL_RESEARCHCOMPLETED",     (TRIGGER_TYPE)CALL_RESEARCHCOMPLETED, scrCBResCompleted,
		1,	{ (INTERP_TYPE)(VAL_REF|ST_RESEARCH) } },

	{ "CALL_NEWDROID",				(TRIGGER_TYPE)CALL_NEWDROID,			scrCBNewDroid,
		3,	{ VAL_INT, (INTERP_TYPE)(VAL_REF|ST_DROID),(INTERP_TYPE)(VAL_REF|ST_STRUCTURE)	   } },

	{ "CALL_STRUCT_ATTACKED",		(TRIGGER_TYPE)CALL_STRUCT_ATTACKED,	scrCBStructAttacked,
		3,	{ VAL_INT, (INTERP_TYPE)(VAL_REF|ST_STRUCTURE), (INTERP_TYPE)(VAL_REF|ST_BASEOBJECT) } },

	{ "CALL_DROID_ATTACKED",		(TRIGGER_TYPE)CALL_DROID_ATTACKED,	scrCBDroidAttacked,
		3,	{ VAL_INT, (INTERP_TYPE)(VAL_REF|ST_DROID), (INTERP_TYPE)(VAL_REF|ST_BASEOBJECT) } },

	{ "CALL_ATTACKED",				(TRIGGER_TYPE)CALL_ATTACKED,			scrCBAttacked,
		3,	{ VAL_INT, (INTERP_TYPE)(VAL_REF|ST_BASEOBJECT), (INTERP_TYPE)(VAL_REF|ST_BASEOBJECT) } },
	...
	{ "CALL_FEATURE_SEEN",			(TRIGGER_TYPE)CALL_FEATURE_SEEN,		scrCBFeatureSeen,
		3,	{ VAL_INT, (INTERP_TYPE)(VAL_REF|ST_FEATURE), (INTERP_TYPE)(VAL_REF|ST_BASEOBJECT) } },
	...
	{ "CALL_ALLIANCEOFFER",			(TRIGGER_TYPE)CALL_ALLIANCEOFFER,		scrCBAllianceOffer,
		2,	{ (INTERP_TYPE)(VAL_REF|VAL_INT),(INTERP_TYPE)(VAL_REF|VAL_INT) }},

	/* This entry marks the end of the callback list */
	{ "CALLBACK LIST END", (TRIGGER_TYPE)0 }
};
