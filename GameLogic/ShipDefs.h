...
namespace Neuron
{
  ...
  {
    { ShipClass::Asteria,   50.0f, 20.0f, 2.0f, 100.0f, 5.0f, "Asteria" },
    { ShipClass::Aurora,    70.0f, 30.0f, 3.0f,  80.0f, 4.0f, "Aurora" },
    { ShipClass::Avalanche, 40.0f, 15.0f, 1.5f, 150.0f, 7.0f, "Avalanche" },
  };
